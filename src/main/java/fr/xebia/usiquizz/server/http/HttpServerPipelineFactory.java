 ...
 * under the License.
 */
package fr.xebia.usiquizz.server.http;

import fr.xebia.usiquizz.core.persistence.UserRepository;
import fr.xebia.usiquizz.server.http.resources.CachedResourcesRequestHandler;
import fr.xebia.usiquizz.server.http.rest.RestRequestHandler;
