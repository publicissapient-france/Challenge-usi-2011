...
public class LoginResourceRequestHandler extends RestHandler {
    ...
    public void post(final HttpRequest request, final HttpResponse response) {
        ...
        try {
            ...
            JsonParser jp = jsonFactory.createJsonParser(request.getBodyBuffer().array(), 0,
                    request.getBodyBuffer().limit());
            ...
            if (mail != null && password != null) {
                ...
                if (res) {
                    ...
                    String key = initCookie(request, response);
                    game.addPlayer(key, mail);
